...
export const WAVESPEED_DEFAULT_CONTENT_MODEL: WavespeedContentModel =
  "deepseek-ai/deepseek-v3";
...
/** Default image model */
export const WAVESPEED_DEFAULT_IMAGE_MODEL: WavespeedImageModel =
  "wavespeed-ai/flux-schnell";
...
/** Default video model */
export const WAVESPEED_DEFAULT_VIDEO_MODEL: WavespeedVideoModel =
  "wavespeed-ai/vidu-2.0";
...
export function isValidWavespeedContentModel(
  model: string,
): model is WavespeedContentModel {
...
export function isValidWavespeedImageModel(
  model: string,
): model is WavespeedImageModel {
...
export function isValidWavespeedVideoModel(
  model: string,
): model is WavespeedVideoModel {
 ...
 */
export function resolveWavespeedContentModel(
  envModel?: string,
 ...
 */
export function resolveWavespeedImageModel(
  envModel?: string,
): WavespeedImageModel {
 ...
 */
export function resolveWavespeedVideoModel(
  envModel?: string,
): WavespeedVideoModel {
