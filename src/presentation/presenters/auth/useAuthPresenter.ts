...
export function useAuthPresenter(
  ...
  const state: AuthPresenterState = useMemo(() => ({
    ...
    user, profile, profiles, session, isAuthenticated, isLoading, error,
  ...
  const actions: AuthPresenterActions = useMemo(() => ({
    ...
    signOut, resetPassword, updatePassword, updateProfile, getProfiles, switchProfile, createProfile, refreshSession,
