 ...
 * Compact footer with copyright and social links
 */
    ...
    <footer className="h-12 px-6 flex items-center justify-between border-t border-border/30 bg-surface/20 backdrop-blur-sm">
      ...
      <div className="flex items-center gap-3">
        <a
          ...
          className="w-8 h-8 rounded-lg bg-surface/50 hover:bg-surface flex items-center justify-center text-muted hover:text-foreground transition-all duration-200"
          aria-label="GitHub"
        >
